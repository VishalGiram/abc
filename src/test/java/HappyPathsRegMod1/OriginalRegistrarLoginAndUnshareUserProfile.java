...
public class OriginalRegistrarLoginAndUnshareUserProfile extends base {
...
//		}
	...
	/*
     *TC_Id      : C0003
     *Tc_Title   : original_Jurisdiction_Registrar_Login_And_UnShare_User_Profile_With_Welcoming_jurisdiction
     *Author     : pravin.jogi@eqanim.com           
     */
	@Test(priority = 3,retryAnalyzer = Analyzer.RetryAnalyzer.class,groups= {"module1"})
	public void original_Jurisdiction_Registrar_Login_And_UnShare_User_Profile_With_Welcoming_jurisdiction() throws Exception {
		...
		System.out.println("Original Jurisdiction registrar share user profile with welcoming jurisdiction successfully");
		ObjectRepo.test.log(Status.PASS, "Original Jurisdiction registrar share user profile with welcoming jurisdiction successfully");
		//Original Jurisdiction Registrar(california) Unshare profile with Welcoming Jurisdiction
		ref1.registrarSearchUserAndGoToUserDetailsPage();
		ref1.originalJurisdictionRegistrarUnshareUserProfileWithWelcomingJurisdiction();
		System.out.println("Original Jurisdiction registrar Unshare user profile with welcoming jurisdiction successfully");
		ObjectRepo.test.log(Status.PASS, "Original Jurisdiction registrar Unshare user profile with welcoming jurisdiction successfully");
		}
