...
public class RegistrarDeniedProposedUserDetails extends base {
...
//	}
	...
	/*
	 *TC_Id      : C0002
	 *Tc_Title   : Registrar_Login_And_Denied_Proposed_User_Details
	 *Author     : pravin.jogi@eqanim.com           
	 */
	@Test(priority = 2,retryAnalyzer = Analyzer.RetryAnalyzer.class,groups= {"module1"})
	public void registrar_Login_And_Denied_Proposed_User_Details() throws Exception {
		...
		System.out.println("Registrar Denied proposed user details successfully");
		ObjectRepo.test.log(Status.PASS, "Registrar Denied proposed user details successfully");
	}
